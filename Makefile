...
build-test-image:
	...
	@scripts/update-resources -scenario build-image ray-operator/test/e2eautoscaler/support.go
	...
	@echo "=== Contents of e2eautoscaler/support.go (resource values) ==="
	@grep -n 'resource\.MustParse(' ray-operator/test/e2eautoscaler/support.go | grep -E '"(500m|1000m|2000m|1G|3G|6G|10G)"'
